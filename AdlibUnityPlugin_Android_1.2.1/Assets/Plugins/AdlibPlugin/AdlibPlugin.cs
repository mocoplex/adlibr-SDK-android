...
public class AdlibPlugin : MonoBehaviour {
	...
	public static void InitializeAdlib(string ads) {
		if(adlibPluginClass == null)
			adlibPluginClass = new AndroidJavaClass("com.mocoplex.adlib.unity.AdlibPlugin");
		unityPlayer = new AndroidJavaClass("com.unity3d.player.UnityPlayer");
		currActivity = unityPlayer.GetStatic<AndroidJavaObject>("currentActivity");
		adlibPluginClass.CallStatic("Initialize", currActivity, ads);
	}
