...
/*
 * confirmed compatible with mobfox SDK 6.0.0
*/
...
public class SubAdlibAdViewMobfox extends SubAdlibAdViewCore  {
		...
		public void initMobfoxView()
		{
			...
			ad.setAdListener( new AdListener(){
				...
				public void adClicked() {
					AdlibConfig.getInstance().clk(Type.BANNER, "MOBFOX");
				}
				...
				public void adLoadSucceeded(Ad arg0) {
					...
					gotAd();
					AdlibConfig.getInstance().imp(Type.BANNER, "MOBFOX");
				}
		...
		public static void loadInterstitial(Context ctx, final Handler h)
		{
			...
			mManager.setListener( new AdListener(){
				...
				@Override
				public void adClicked() {
					AdlibConfig.getInstance().clk(Type.INTERSTITIAL, "MOBFOX");
				}
