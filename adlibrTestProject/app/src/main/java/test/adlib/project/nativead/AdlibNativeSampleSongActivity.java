...
public class AdlibNativeSampleSongActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_native_song_list);
        ...
        _amanager.loadNativeAd(AdlibConfig.ContentType.ALL, new AdlibNativeAdListener() {
            ...
            public void onError(int errorCode) {
                ...
                Toast.makeText(AdlibNativeSampleSongActivity.this, "광고수신 실패 :)", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public class Adapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (type == VIEW_TYPE) {
                ...
                // 기본 뷰에 대해 처리를 합니다.
                if (convertView == null) {
                    convertView = getLayoutInflater().inflate(R.layout.activity_native_song_item_sample, null);
                }
